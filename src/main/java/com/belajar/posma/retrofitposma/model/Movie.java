...
public class Movie implements Parcelable {
    ...
    public Movie(String posterPath, boolean adult, String overview, String releaseDate, List<Integer> genreIds, Integer id,
                 ...
                 Integer voteCount, Boolean video, Double voteAverage, Double budget, String status, String tagline, String homepage, Integer runtime) {
    ...
    public void setStatus(String budget) {
        this.status = status;
    }
